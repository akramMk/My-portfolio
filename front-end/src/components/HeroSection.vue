            ...
            <div class="grid lg:grid-cols-2 gap-10 xl:gap-14 relative pt-24 lg:max-w-none max-w-2xl md:max-w-3xl mx-auto">
                <div class="lg:py-6">
                    ...
                    <p class="text-gray-300 pt-8 text-center lg:text-left mx-auto max-w-xl">
                        I am a Data Scientict and Back-End Enthusiast, currently completing a Master’s in Computer Science at Lyon 1. 
                        My expertise lies in Generative AI, custom LLMs, and scalable AI solutions, with a strong focus on RAG models 
                        and prompt engineering. In addition to my AI background, I have a keen interest in web development, 
                        with skills in Spring Boot, Express.js and Django, allowing me to build full-stack applications that integrate AI capabilities. 
                    </p>
                ...
                <div class="lg:h-full md:flex">
                    <div class="flex w-full h-96 min-h-[24rem] lg:min-h-[none] lg:w-full lg:h-full items-center relative">
                        ...
                        <div class="absolute h-full z-10 p-2 -translate-y-1/2 top-1/2 lg:right-3 md:right-40 sm:right-16 rounded-full shadow-lg border border-primary">
                            <img src="@/assets/profile-photo.jpg" alt="My pic" width="500" height="auto" loading="lazy"
